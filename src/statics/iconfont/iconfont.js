...
src: url('iconfont.eot?t=1547428898135'); /* IE9 */
src: url('iconfont.eot?t=1547428898135#iefix') format('embedded-opentype'), /* IE6-IE8 */
...
url('iconfont.woff?t=1547428898135') format('woff'),
url('iconfont.ttf?t=1547428898135') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
url('iconfont.svg?t=1547428898135#iconfont') format('svg'); /* iOS 4.1- */
}
